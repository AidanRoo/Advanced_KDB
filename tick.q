...
//call sym file 
system raze["l ",getenv[`Advanced_KDB],"/tick/sym.q"]
system"l ",getenv[`Advanced_KDB],"/tick/",(src:first .z.x,enlist"sym"),".q"

if[not system"p";system"p 5010"]
system raze["l ",getenv[`Advanced_KDB],"/logging.q"]
system raze["l ",getenv[`Advanced_KDB],"/tick/u.q"]
...
//Logging number of messages and subscribers
\d .log
.log.a::0;

logger:{$[a mod 60;[a::a+1;::];[a::a+1;.log.out[raze[(string[.z.P],"\n Message Count:\n ",string[.u.i],"\nSubscribers:\n",.Q.s[.u.w])]]]]};
\d .
...
tick:{init[];if[not min(`time`sym~2#key flip value@)each t;`time`sym];@[;`sym;`g#]each t;d::.z.D;if[l::count y;L::`$":",y,"/",x,10#".";l::ld d]};
